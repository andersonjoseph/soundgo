...
func encodeCreatePasswordResetResponse(response CreatePasswordResetRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *CreatePasswordResetNoContent:
		w.WriteHeader(204)
		span.SetStatus(codes.Ok, http.StatusText(204))

		return nil

	case *CreatePasswordResetBadRequest:
