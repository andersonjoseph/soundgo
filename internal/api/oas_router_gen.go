...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			switch elem[0] {
			case 'a': // Prefix: "audios"
				origElem := elem
				if l := len("audios"); len(elem) >= l && elem[0:l] == "audios" {
					elem = elem[l:]
				} else {
					break
				}
				...
				if len(elem) == 0 {
					switch r.Method {
					case "POST":
						s.handleCreateAudioRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "PATCH":
							s.handleUpdateAudioRequest([1]string{
								args[0],
							}, elemIsEscaped, w, r)
						default:
					...
					case '/': // Prefix: "/file"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetAudioFileRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/audios"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetUserAudiosRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "audios"
				...
				if len(elem) == 0 {
					...
					case "POST":
						r.name = "CreateAudio"
						r.summary = "Upload audio"
						r.operationID = "createAudio"
						r.pathPattern = "/audios"
						r.args = args
						r.count = 0
						return r, true
					default:
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "PATCH":
							r.name = "UpdateAudio"
							r.summary = "Update audio"
							r.operationID = "updateAudio"
							r.pathPattern = "/audios/{id}"
							r.args = args
							r.count = 1
							return r, true
					...
					case '/': // Prefix: "/file"
						...
						if len(elem) == 0 {
							...
							case "GET":
								r.name = "GetAudioFile"
								r.summary = "Stream audio"
								r.operationID = "getAudioFile"
								r.pathPattern = "/audios/{id}/file"
								r.args = args
								r.count = 1
								return r, true
							default:
			...
			case 'p': // Prefix: "password-reset"
				...
				if len(elem) == 0 {
					...
					case "POST":
						...
						return r, true
					case "PUT":
						r.name = "ResetPassword"
						r.summary = "Reset a password"
			...
			case 'u': // Prefix: "users"
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "PATCH":
							r.name = "UpdateUser"
							r.summary = "Update an existing user"
					...
					case '/': // Prefix: "/audios"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = "GetUserAudios"
								r.summary = "Get user's audios"
								r.operationID = "getUserAudios"
								r.pathPattern = "/users/{id}/audios"
								r.args = args
								r.count = 1
								return r, true
							default:
